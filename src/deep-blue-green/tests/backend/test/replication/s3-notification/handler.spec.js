// THIS TEST WAS GENERATED AUTOMATICALLY ON Sat Feb 25 2017 20:37:47 GMT-0500 (EST)

'use strict';

import chai from 'chai';
import Handler from '../../../../../backend/src/replication/s3-notification/Handler';
...
suite('Handlers', () => {
  ...
  test('Class Handler exists in replication-s3-notification module', () => {
